...
//geting quantity from cart
  	...
  	$run_order=mysqli_query($con,$insert_order);
  		...
  		echo "<script>alert('Order successfully submitted,Thinks! ')</script>";
  		echo "<script>window.open('customer/my_account.php','_self')</script>";
  		  		 $insert_to_pending_orders="insert into pending_orders(customer_id,invoice_no,products_id,qty,order_status) values('$customer_id','$invoice_no','$pro_id','$qty','$status')";
  		$run_pending_order=mysqli_query($con, 
