...
<table width="794" align="center" border="1" bgcolor="silver">
<tr align="center">
	<td colspan="2">
		<h2>Update Or Edit Product  </h2>
	</td>
</tr>
...
<tr>
	...
	<td> <input type="file" name="product_img1"/><br><img src="product_images/<?php echo 
	$p_img1  ?>" width="80" height="80"/></td>
</tr>
<tr>
	<td align="right"><b>Product Image 2</b></td>
	<td> <input type="file" name="product_img2"/><br><img src="product_images/<?php echo 
	$p_img2  ?>" width="80" height="80"/></td>
</tr>
<tr>
	<td align="right"><b>Product Image 3</b></td>
	<td> <input type="file" name="product_img3"/><br><img src="product_images/<?php echo 
	$p_img3  ?>" width="80" height="80"/></td>
</tr>
<tr>
...
<tr>
	...
	<td><textarea name="product_desc" color="35" rows="10"><?php echo $p_desc;?></textarea> </td>
</tr>
<tr>
...
if(isset($_POST['update_product']))
{
	...
	if ($product_title=='' OR $product_cat==''OR $product_brand=='' OR 
	...
	else
	{
		...
		move_uploaded_file($temp_name1,
			"product_images/$product_img1");
		move_uploaded_file($temp_name2,
			"product_images/$product_img2");
		move_uploaded_file($temp_name3,
			"product_images/$product_img3");


	

	$update_product="update products set cat_id='$product_cat',brand_id='
	$product_brand',date=NOW(),product_title='$product_title',product_img1='$product_img1',product_img2='$product_img2',product_img3='$product_img3',product_price='$product_price',product_desc='$product_desc',product_keywords='$product_keywords' where products_id='$update_id'";
