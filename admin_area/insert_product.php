...
<tr>
	...
	<td><textarea name="product_desc" color="35" rows="10"></textarea> </td>
</tr>
<tr>
...
if(isset($_POST['insert_product']))
{
	...
	$insert_product="insert into products (cat_id,brand_id,date,product_title, 
		...
		product_desc,status) values (
		'$product_cat',
		'$product_brand',NOW(),
		'$product_title','$product_img1',
...
if($run_product){
	...
	echo"<script>
	window.open('index.php?insert_product','_self')
	</script>";
}
